...
# Disable Dynamo for dequantization as it struggles with the bitwise ops and reshaping
if hasattr(torch, "compiler"):
    disable_compile = torch.compiler.disable
else:
    def disable_compile(x): return x
